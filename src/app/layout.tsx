...
export const metadata: Metadata = {
  title: "Sababa Tel Aviv - Authentic Israeli Restaurant",
  description: "Experience authentic Israeli Mediterranean cuisine at Sababa in Tel Aviv. Signature hummus, falafel, and grilled specialties. Reserve your table today.",
  keywords: "Israeli restaurant, Tel Aviv dining, Mediterranean cuisine, hummus, falafel, kosher options",
  metadataBase: new URL("https://sababa-telaviv.com"),
  alternates: {
    canonical: "https://sababa-telaviv.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Sababa Tel Aviv - Authentic Israeli Mediterranean Restaurant",
    description: "Discover the flavors of Israel at Sababa. Authentic Mediterranean cuisine prepared with fresh ingredients and time-honored traditions.",
    type: "website",
    siteName: "Sababa Tel Aviv",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765873807053-y2a1svr1.jpg",
        alt: "Israeli hummus plate"
      }
    ]
  },
  twitter: {
    ...
    title: "Sababa Tel Aviv - Authentic Israeli Restaurant",
    description: "Experience authentic Mediterranean cuisine in the heart of Tel Aviv",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765873807053-y2a1svr1.jpg"]
  }
};
